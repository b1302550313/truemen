...
import com.truemen.api.agreement.protocol.login.dto.ChatRecordDto;
import com.truemen.api.agreement.protocol.login.dto.ChatTalkDto;
import com.truemen.api.agreement.protocol.login.dto.GroupsDto;
import com.truemen.api.agreement.protocol.login.dto.UserFriendDto;
        ...
        for (TalkBoxInfo talkBoxInfo : talkBoxInfoList) {
            ...
            if (Constants.TalkType.Friend.getCode().equals(talkBoxInfo.getTalkType())) {
                ...
                List<ChatRecordInfo> chatRecordInfoList = userService.queryChatRecordInfoList(talkBoxInfo.getTalkId(),
                        msg.getUserId(), Constants.TalkType.Friend.getCode());
            ...
            // 群组；聊天消息
                ...
                List<ChatRecordDto> chatRecordDtoList = new ArrayList<>();
                List<ChatRecordInfo> chatRecordInfoList = userService.queryChatRecordInfoList(talkBoxInfo.getTalkId(),
                        msg.getUserId(), Constants.TalkType.Group.getCode());
                for (ChatRecordInfo chatRecordInfo : chatRecordInfoList) {
